#pragma once
/*********
* code written by John Lin aka Lin20 based on original QEF solver written by Rice University researchers
* Link: https://github.com/Lin20/ProjectIW
* edited By Garry Guan to use opengl / glm libs
*********/

...
public:
	...
	void GenerateHermiteHeightMap2D(vector<float> &heightmap);
	
	void *BeginModifyVertexBuffer(int & size);
	void EndModifyVertexBuffer();
	void * BeginModifyIndexBuffer(int & size);
	void EndModifyIndexBuffer();
	
	void BindMesh(GLuint vbo, GLuint ebo);
